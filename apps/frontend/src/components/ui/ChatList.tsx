...
import { conversations, users, messages } from "@/lib/api" // Add messages import
import { Conversation, User, Message } from "@/lib/types" // Add Message type
...
interface ConversationWithUser extends Conversation {
    otherUser: User
    unreadCount?: number
    lastMessage?: Message // Add last message
}

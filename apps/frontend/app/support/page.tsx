...
import { Github, MessageCircle, Mail, FileText, Info } from "lucide-react"
    ...
    },
    {
        ...
        answer: (
            <>
                ...
                <Link
                    href="https://github.com/xcfio/chat-app/issues"
                    target="_blank"
                    variant="link"
            ...
            <div className="max-w-3xl w-full space-y-8">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <Link
                                href="https://github.com/xcfio/chat-app#readme"
                                target="_blank"
                                rel="noopener noreferrer"
                                variant="outline"
                                className="w-full"
